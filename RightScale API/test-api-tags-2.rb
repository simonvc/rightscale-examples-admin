...
# http_method = "get"
http_method = "put"
params = { 'server[ec2_security_groups_href][0]' => 'https://my.rightscale.com/clouds/1/ec2_security_groups/122351' }

# puts api.send(url, http_method, params )

# puts api.send("servers/754935")

# params = {'resource_href' => 'https://my.rightscale.com/api/acct/7954/server/687102', 'tags[]' => 'aaa'}
# puts api.send("tags/set?resource_href=https://my.rightscale.com/api/acct/7954/server/687102&tags[]=bbb","put")

api.send("servers/754935", http_method, params)
